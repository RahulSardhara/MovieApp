...
@Composable
fun MainContent(paddingValues: PaddingValues, movieList: List<String> = listOf("Avatar", "300", "Harry Potter", "Inception", "The Dark Knight", " Interstellar", "The Matrix", "Titanic", "Gladiator", "The Lord of the Rings", "Jurassic Park")) {
    Column(
        modifier = Modifier
            .fillMaxSize()
